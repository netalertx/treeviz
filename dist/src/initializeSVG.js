...
export const initiliazeSVG = (treeConfig) => {
    const { htmlId, isHorizontal, hasPan, hasZoom, mainAxisNodeSpacing, nodeHeight, nodeWidth, marginBottom, marginLeft, marginRight, marginTop, } = treeConfig;
    const margin = {
        top: marginTop,
        right: marginRight,
        bottom: marginBottom,
    ...
    const MainG = ZoomContainer.append("g").attr("transform", mainAxisNodeSpacing === "auto"
        ? "translate(0,0)"
        : isHorizontal
            ? "translate(" +
                margin.left +
...
//# sourceMappingURL=initializeSVG.js.map